...
namespace HttpServer {
    ...
    public class HttpProcessor {
        ...
        public void writeSuccess(string content_type="text/html") {
			...
			outputStream.WriteLine("Access-Control-Allow-Headers:content-type");
    ...
    public abstract class HttpServer {
		...
		public abstract void handleOPTIONSRequest(HttpProcessor p);
    }
	...
	public class MyHttpServer : HttpServer
	{
		...
		public string qrData(string jsonInput)
		{
			dynamic obj = JsonConvert.DeserializeObject(jsonInput);
